...
const UpdateListing = () => {
  ...
  return (
    <main className="p-3 max-w-4x mx-auto">
      
      <h1 className="text-3xl font-semibold text-center my-7"> Upadte Listing ...</h1>
       ...
       <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <textarea onChange={handleChange} value={formData.description} type="text" id="description" placeholder="Description ..." className="border p-3 rounded-lg" required />
           <input onChange={handleChange} value={formData.address} type="text" placeholder="Adress" id="address" className="border p-3 rounded-lg" required />
           ...
           <div className=" flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <input onChange={handleChange} value={formData.regularPrice} type="number" id="regularPrice" min="50" max="10000000" required 
              className="p-3 border border-gray-300 rounded-lg"
              />
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button disabled={uploading} type='button' onClick={handleImageSubmit} className="p-3 text-green-700 border border-green-700 rounded uppercase first-letter:
           ...
           
           {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url , index) =>(
              ...
              <div key={url} className='flex justify-between p-3 border items-center'>
                ...
                <button type='button' onClick={()=> handleRemoveImage(index)} className='p-3 font-semibold text-red-700 rounded-lg uppercase hover:opacity-75'>Delete</button>
